...
export default {
  ...
  methods: {
    ...
    notificationOutputModule(newState, oldState) {
      if (this.settings.outputNotificationTranscript !== 'on') return
    ...
    soundOutputModule(newState, oldState) {
      if (this.settings.outputSound !== 'on') return
      ...
      function getToneGenerator() {
        ...
        //will casue warnings if the user hasn't interacted with the page
  ...
  <div v-if="state">
    <div id="vxchrome">
      <div
        ...
        :state-final="state.finalTranscript ? 'true' : 'false'"
      >
        <span class="initial">&gt;&gt;&gt;&nbsp;</span>
        <span class="final">{{ state.finalTranscript }}</span>
